...
-- AddForeignKey
ALTER TABLE "StvRoundResult" ADD CONSTRAINT "StvRoundResult_stvResultId_fkey" FOREIGN KEY ("stvResultId") REFERENCES "StvResult"("votationId") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VotationResult" ADD CONSTRAINT "VotationResult_votationId_fkey" FOREIGN KEY ("votationId") REFERENCES "Votation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
